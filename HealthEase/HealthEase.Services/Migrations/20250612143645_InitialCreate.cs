    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "test@mai.com", "test", false, "test", "wSG+yBth9HCj0O1AdRBL+CJjtR4=", "c0MJh5XS8DYQtkJavp5lsA==", "123456789", null, "test" },
                    { 2, null, "admin@mail.com", "Admin", false, "Test", "wSG+yBth9HCj0O1AdRBL+CJjtR4=", "c0MJh5XS8DYQtkJavp5lsA==", "000000000", null, "desktop" },
                    { 3, null, "robert.t@mail.com", "Robert", false, "Trahan", "uAQkJu5IuKT3FArAvq4E5KbBzRI=", "ppASfJlw8D6P+mNsl7bqMA==", "062543234", null, "doctor" },
                    { 4, null, "paul.u@mail.com", "Paul", false, "Ulrey", "uAQkJu5IuKT3FArAvq4E5KbBzRI=", "ppASfJlw8D6P+mNsl7bqMA==", "062222333", null, "doctor1" },
                    { 5, null, "james.l@mail.com", "James", false, "Lozano", "uAQkJu5IuKT3FArAvq4E5KbBzRI=", "ppASfJlw8D6P+mNsl7bqMA==", "062958342", null, "doctor2" },
                    { 6, null, "helen.e@mail.com", "Helen", false, "Evans", "uAQkJu5IuKT3FArAvq4E5KbBzRI=", "ppASfJlw8D6P+mNsl7bqMA==", "062332123", null, "doctor3" },
                    { 7, null, "james.s@mail.com", "James", false, "Smith", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "061222111", null, "james.s" },
                    { 8, null, "emma.j@mail.com", "Emma", false, "Johnson", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "060111222", null, "emma.j" },
                    { 9, null, "liam.w@mail.com", "Liam", false, "Williams", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "065333444", null, "liam.w" },
                    { 10, null, "olivia.b@mail.com", "Olivia", false, "Brown", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "064222333", null, "olivia.b" },
                    { 11, null, "mason.d@mail.com", "Mason", false, "Davis", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "063444555", null, "mason.d" },
                    { 12, null, "ava.m@mail.com", "Ava", false, "Miller", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "062111999", null, "ava.m" },
                    { 13, null, "lucas.g@mail.com", "Lucas", false, "Garcia", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "061555888", null, "lucas.g" },
                    { 14, null, "mia.r@mail.com", "Mia", false, "Rodriguez", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "065777666", null, "mia.r" },
                    { 15, null, "jack.m@mail.com", "Jack", false, "Martinez", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "064888777", null, "jack.m" },
                    { 16, null, "sophia.h@mail.com", "Sophia", false, "Hernandez", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "063666555", null, "sophia.h" },
                    { 17, null, "logan.l@mail.com", "Logan", false, "Lopez", "uAQkJu5IuKT3FArAvq4E5KbBzRI", "ppASfJlw8D6P+mNsl7bqMA==", "061999222", null, "logan.l" },
                    { 18, null, "sabrina.g@mail.com", "Sabrina", false, "Gallagher", "3JVNj98T0GrBkWatJPLYoaIqBEA=", "/gLAN9q37ktD4sUpWLjN1g==", "062532195", null, "assistant" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Hi! How can I assist you today?", null, false, true, 1, 2, "User", new DateTime(2025, 6, 12, 9, 35, 0, 0, DateTimeKind.Unspecified), 2 },
                    ...
                    { 4, "Yes, please suggest a new date and I'll check my schedule.", null, false, true, 1, 3, "User", new DateTime(2025, 6, 15, 14, 5, 0, 0, DateTimeKind.Unspecified), 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0), 1, null, 1, false, false, "Requesting general checkup.", 1, null, "Pending", null },
                    { 2, new DateTime(2025, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 11, 0, 0, 0), 2, null, 4, false, false, "Consultation for recurring headaches.", 1, null, "Approved", "Approved" },
                    { 3, new DateTime(2025, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 0, 0, 0), 3, null, 2, false, true, "Lab results follow-up.", 2, new DateTime(2025, 4, 12, 8, 0, 0, 0, DateTimeKind.Unspecified), "Paid", "Payment completed" },
                    { 4, new DateTime(2025, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 14, 0, 0, 0), 1, null, 3, false, true, "Scheduled preventive check.", 1, new DateTime(2025, 5, 1, 9, 0, 0, 0, DateTimeKind.Unspecified), "Paid", "Payment completed" },
                    { 5, new DateTime(2025, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 13, 0, 0, 0), 2, null, 4, false, true, "Consultation about recurring migraines.", 2, new DateTime(2025, 6, 10, 11, 0, 0, 0, DateTimeKind.Unspecified), "Paid", "Paid - consultation" },
                    { 6, new DateTime(2025, 7, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 15, 0, 0, 0), 1, null, 5, false, true, "General checkup.", 2, new DateTime(2025, 6, 16, 14, 0, 0, 0, DateTimeKind.Unspecified), "Paid", "Paid online" },
                    { 7, new DateTime(2025, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0), 3, null, 6, false, true, "Pediatric consultation.", 3, new DateTime(2025, 6, 19, 10, 0, 0, 0, DateTimeKind.Unspecified), "Paid", "Payment confirmed" },
                    ...
                    { 10, new DateTime(2025, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 12, 0, 0, 0), 2, null, 1, false, false, "Follow-up visit.", 1, null, "Approved", "See you on time" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, "Excellent doctor, very thorough and kind.", new DateTime(2025, 5, 12, 12, 15, 0, 0, DateTimeKind.Unspecified), null, 2, false, 2, 5 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 60.0, 3, null, false, 1, "PAYER-003", "PAYID-000003", "PayPal", new DateTime(2025, 4, 12, 8, 15, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 75.0, 4, null, false, 1, "PAYER-004", "PAYID-000004", "PayPal", new DateTime(2025, 5, 1, 9, 30, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 90.0, 5, null, false, 2, "PAYER-005", "PAYID-000005", "PayPal", new DateTime(2025, 6, 10, 11, 10, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 55.0, 6, null, false, 2, "PAYER-006", "PAYID-000006", "PayPal", new DateTime(2025, 6, 11, 14, 15, 0, 0, DateTimeKind.Unspecified) },
                    { 5, 70.0, 7, null, false, 3, "PAYER-007", "PAYID-000007", "PayPal", new DateTime(2025, 6, 12, 10, 20, 0, 0, DateTimeKind.Unspecified) }
                });
