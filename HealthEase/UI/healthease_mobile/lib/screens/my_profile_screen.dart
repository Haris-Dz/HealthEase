              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: CircleAvatar(
                      radius: 60,
                      backgroundImage: (_patient?['profilePicture'] == null || _patient!['profilePicture'] == "AA==")
                          ? const AssetImage('assets/images/placeholder.png') as ImageProvider
                          : MemoryImage(base64Decode(_patient!['profilePicture'])),
                    ),
                  ),
                  ...
                  _buildInfoRow("Registered", (_patient?['registrationDate'] as String).split('T').first),
